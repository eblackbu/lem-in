...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/24 12:24:51 by eblackbu          #+#    #+#             */
/*   Updated: 2020/02/24 12:41:04 by eblackbu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void 			print_links_help(t_room *rooms, int count_rooms)
{
	int i = 0;
	t_link	*tmp;
	while (i < count_rooms)
...
int		main(int ac, char **av)
{
	...
	freopen("/Users/eblackbu/lem-in/maps/valid/map_subject_3", "r", stdin);
	lemin = validation();
