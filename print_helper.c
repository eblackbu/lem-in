...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/29 13:36:22 by eblackbu          #+#    #+#             */
/*   Updated: 2020/02/29 13:38:51 by eblackbu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
							...
							int all_ants, int flag_space)
{
	...
	while (i >= 0)
	{
		if (!i && is_fast_path((*lemin)->paths, (*lemin)->count_ants, path_val))
		{
...
((*lemin)->paths[path_val].roomnum_path[i].is_ant_here == 0 || \
i == (*lemin)->paths[path_val].length - 1))
		{
